...
if (defined('FOR_XOOPS_LANG_CHECKER') || !defined($constpref . '_LOADED')) {
    ...
    define($constpref . '_HIJACK_DENYGP', 'Grupos de IP no admitidas que se mueven en una sesión');
    ...
    define($constpref . '_UNION_ACTIONDSC', 'Inyección Anti SQL: <br> Seleccione la acción cuando tenga algún sintaxis como UNION of SQL. <br> "Sanitizing" significa cambiar "unión" por "uni-on". <br> (la opción recomendada es Desinfección)');
    ...
    define($constpref . '_DBTRAPWOSRVDSC', 'e capa DB. Esto causa detecciones incorrectas como ataque de inyección SQL. Si tienes esos errores, activa esta opción. Debes saber que esta opción debilita la seguridad de la captura de la capa de DB contra la inyección de SQL.');
